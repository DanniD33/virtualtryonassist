...
// await model;
  ...
  await poseDetection.createDetector(model, {runtime:'tfjs', solutionPath: 'https://cdn.jsdelivr.net/npm/@mediapipe/pose'}).json();
...
//  await detector.estimatePoses(canvas, estimationConfig);
// }
